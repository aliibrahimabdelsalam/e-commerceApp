...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	private GoogleOAuth2SuccessHandler geogleOAuth2SuccessHandler;
	@Autowired
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.and()
		.oauth2Login().loginPage("/login").successHandler(geogleOAuth2SuccessHandler)  //geogleOAuth2SuccessHandler
	...
	@Bean
	public BCryptPasswordEncoder pwdencod() {
